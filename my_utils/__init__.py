# The "." here is a relative import; it specifies (replaced by) the current directory path it resides in when imported by another module
...
from .tree_optimize import optimize_trees
